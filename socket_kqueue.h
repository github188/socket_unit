...
static bool sp_invalid(int kfd) 
{
	return kfd == -1;
}
...
static void sp_release(int kfd)
{
	close(kfd);
}
...
static int sp_add(int kfd, int sock, void *ud)
{
	struct kevent ke;
...
static void sp_write(int kfd, int sock, void *ud, bool enable)
{
	struct kevent ke;
